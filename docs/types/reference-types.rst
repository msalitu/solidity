...
to append a new element at the end of the array, where ``.push()`` appends a zero-initialized element.
...
**push**:
     ...
     If no argument is given, the element will be zero-initialised and a reference to the new element is returned, if applicable.
